...
const THEMES = {
  ...
  neon: {
    ...
    voiceClips: false,
    avatars: [
      { id: 'jinx', img: 'images/themes/neon/avatar-1.png', name: 'Jinx Nakamura', body: 'Runner · Wired', tagline: 'Lag is death.', lore: 'Courier for the undernet. Streams every run. Has never missed a delivery window or a red light — the grid watches, and so do 40k followers.' },
      { id: 'axel', img: 'images/themes/neon/avatar-2.png', name: 'Axel Voss', body: 'Heavy · Chromed', tagline: 'Read the code, ride the road.', lore: 'Ex-mech-pit engineer. Sees traffic as source code: signs are syntax, signals are logic gates. Debugs intersections in his sleep.' },
      { id: 'nova', img: 'images/themes/neon/avatar-3.png', name: 'Nova Reyes', body: 'Sleek · Ghostware', tagline: 'The grid remembers everything.', lore: 'White-hat gridrunner. Once hacked the city\'s traffic core to stop a pileup. The Authority gave her a choice: prison, or a license. She chose the exam.' }
    ],
    ...
    houses: {
      blood:  { title: 'Sector: TOXIN', subtitle: 'The 0.08 Firewall', icon: '⬢', color: '#ef4444', glow: 'rgba(239,68,68,0.6)',
        ...
        boss: { name: 'OVERPROOF.exe', image: 'images/themes/neon/demon-blood.png', threat: 'The Toxin Protocol', defeatLine: 'My buffer overflowed. You stayed under the limit and deleted me with it.', reward: 'Cleanware Patch' },
      ...
      ember:  { title: 'Sector: HAZE', subtitle: 'The Green Static', icon: '⬡', color: '#22c55e', glow: 'rgba(34,197,94,0.6)',
        ...
        boss: { name: 'HAZE.sys', image: 'images/themes/neon/demon-ember.png', threat: 'The Haze Protocol', defeatLine: 'They whitelisted me and called me safe. You read the fine print.', reward: 'Clarity Driver' },
      ...
      static: { title: 'Sector: PING', subtitle: 'The Phantom Notification', icon: '⌁', color: '#f472b6', glow: 'rgba(244,114,182,0.6)',
        ...
        boss: { name: 'PINGSTORM', image: 'images/themes/neon/demon-static.png', threat: 'The Ping Protocol', defeatLine: 'You muted me. No one mutes me. The crosswalks are yours now.', reward: 'Focus Firmware' },
      ...
      iron:   { title: 'Sector: GLYPH', subtitle: 'The Sign Compiler', icon: '▣', color: '#94a3b8', glow: 'rgba(148,163,184,0.6)',
        ...
        boss: { name: 'SIGNJACK', image: 'images/themes/neon/demon-iron.png', threat: 'The Glyph Protocol', defeatLine: 'You parsed every glyph I scrambled. The compiler accepts you.', reward: 'Parser Module' },
      ...
      thorn:  { title: 'Sector: MERGE', subtitle: 'The Deadlock Engine', icon: '◈', color: '#8b5cf6', glow: 'rgba(139,92,246,0.6)',
        ...
        boss: { name: 'DEADLOCK', image: 'images/themes/neon/demon-thorn.png', threat: 'The Merge Protocol', defeatLine: 'Every intersection was a race condition. You resolved them all.', reward: 'Scheduler Key' },
      ...
      bone:   { title: 'Sector: KERNEL', subtitle: 'The Root Exam', icon: '◉', color: '#f0fdff', glow: 'rgba(240,253,255,0.6)',
        ...
        boss: { name: 'THE KERNEL', image: 'images/themes/neon/demon-bone.png', threat: 'The Root Protocol', defeatLine: 'All tests passed. Access granted. Drive, gridrunner.', reward: 'Root License' },
  ...
  cosmic: {
    ...
    voiceClips: false,
    avatars: [
      { id: 'orion', img: 'images/themes/cosmic/avatar-1.png', name: 'Cadet Orion Vale', body: 'Lean · Quick', tagline: 'Stars don\'t swerve.', lore: 'Grew up on a mining moon where one bad turn meant vacuum. Flies like gravity is a suggestion but treats every rule like a law of physics.' },
      { id: 'zephyr', img: 'images/themes/cosmic/avatar-2.png', name: 'Cadet Zephyr Kane', body: 'Broad · Steady', tagline: 'Check the gauges twice.', lore: 'Third-generation cargo hauler. Has memorized every docking regulation in three star systems. Boring in the sims, unbeatable in the field.' },
      { id: 'lyra', img: 'images/themes/cosmic/avatar-3.png', name: 'Cadet Lyra Moss', body: 'Small · Fearless', tagline: 'The void blinks first.', lore: 'Youngest cadet to solo the asteroid slalom. Talks to her ship. The ship, reportedly, listens.' }
    ],
    ...
    houses: {
      blood:  { title: 'Planet Ethanor', subtitle: 'The 0.08 Nebula', icon: '☄', color: '#f43f5e', glow: 'rgba(244,63,94,0.6)',
        ...
        boss: { name: 'Ethanox the Fogbrain', image: 'images/themes/cosmic/demon-blood.png', threat: 'The Fog Trial', defeatLine: 'My fog dulled a thousand pilots. Your numbers burned it away.', reward: 'Clearsky Medal' },
      ...
      ember:  { title: 'Planet Verdant', subtitle: 'The Slowfield', icon: '❋', color: '#4ade80', glow: 'rgba(74,222,128,0.6)',
        ...
        boss: { name: 'Sporeling the Slow', image: 'images/themes/cosmic/demon-ember.png', threat: 'The Spore Trial', defeatLine: 'Legal in six systems, deadly in all of them. You knew the difference.', reward: 'Quickmind Medal' },
      ...
      static: { title: 'Planet Signalis', subtitle: 'The Distraction Belt', icon: '✧', color: '#f0abfc', glow: 'rgba(240,171,252,0.6)',
        ...
        boss: { name: 'The Siren of Screens', image: 'images/themes/cosmic/demon-static.png', threat: 'The Signal Trial', defeatLine: 'A thousand pilots looked at me instead of the walkway. You never did.', reward: 'Watcher\'s Medal' },
      ...
      iron:   { title: 'Planet Glyphos', subtitle: 'The Beacon Code', icon: '✹', color: '#94a3b8', glow: 'rgba(148,163,184,0.6)',
        ...
        boss: { name: 'Glyphmaster Orn', image: 'images/themes/cosmic/demon-iron.png', threat: 'The Beacon Trial', defeatLine: 'Every beacon I scrambled, you read true. The corridor is lit for you now.', reward: 'Navigator\'s Medal' },
      ...
      thorn:  { title: 'Planet Vexis', subtitle: 'The Crossing Lanes', icon: '❖', color: '#a78bfa', glow: 'rgba(167,139,250,0.6)',
        ...
        boss: { name: 'The Collider Queen', image: 'images/themes/cosmic/demon-thorn.png', threat: 'The Collision Trial', defeatLine: 'Every crossing was my web. You threaded all of them untouched.', reward: 'First-Passage Medal' },
      ...
      bone:   { title: 'The Star Ledger', subtitle: 'The Final Orbit', icon: '☽', color: '#fefce8', glow: 'rgba(254,252,232,0.6)',
        ...
        boss: { name: 'Lord Ledger of the Void', image: 'images/themes/cosmic/demon-bone.png', threat: 'The Ledger Trial', defeatLine: 'Every debt in my ledger, paid in full. Fly, cadet. The stars are yours.', reward: 'Bureau Wings' },
  ...
  realm: {
    ...
    voiceClips: false,
    avatars: [
      { id: 'bram', img: 'images/themes/realm/avatar-1.png', name: 'Bram of the Hollow', body: 'Wiry · Swift', tagline: 'A quick blade, a quicker brake.', lore: 'Stable boy who memorized every road law in the castle library. The knights laughed. Then he out-rode all of them.' },
      { id: 'ser-una', img: 'images/themes/realm/avatar-2.png', name: 'Ser Una Thorne', body: 'Tall · Ironclad', tagline: 'The Oath before the sword.', lore: 'Youngest squire ever knighted, stripped of her title for one reckless ride. She is here to earn it back the right way.' },
      { id: 'wren', img: 'images/themes/realm/avatar-3.png', name: 'Wren the Wayfinder', body: 'Small · Sharp-eyed', tagline: 'Every sign is a spell.', lore: 'Hedge-witch\'s apprentice who reads waystones like scripture. Claims the roads whisper their rules to anyone patient enough to listen.' }
    ],
    ...
    houses: {
      blood:  { title: 'The Sotted Road', subtitle: 'The 0.08 Curse', icon: '🍷', color: '#b91c1c', glow: 'rgba(185,28,28,0.6)',
        ...
        boss: { name: 'Meadwyrm the Sotted', image: 'images/themes/realm/demon-blood.png', threat: 'The Sotted Trial', defeatLine: 'A thousand riders toasted my name and fell. You counted, and stood.', reward: 'Sigil of the Clear Head' },
      ...
      ember:  { title: 'The Smokewood', subtitle: 'The Green Enchantment', icon: '🌿', color: '#65a30d', glow: 'rgba(101,163,13,0.6)',
        ...
        boss: { name: 'Hazeleaf the Lawful', image: 'images/themes/realm/demon-ember.png', threat: 'The Smoke Trial', defeatLine: 'The market sold me freely and called me harmless. You read the deeper law.', reward: 'Sigil of the Steady Hand' },
      ...
      static: { title: 'The Whisperway', subtitle: 'The Phantom Whisper', icon: '🔮', color: '#c084fc', glow: 'rgba(192,132,252,0.6)',
        ...
        boss: { name: 'The Whisperwisp', image: 'images/themes/realm/demon-static.png', threat: 'The Whisper Trial', defeatLine: 'Every rider looked into the glass eventually. You kept your eyes on the road.', reward: 'Sigil of the Waking Eye' },
      ...
      iron:   { title: 'The Runestone Pass', subtitle: 'The Waystone Code', icon: '🗿', color: '#a8a29e', glow: 'rgba(168,162,158,0.6)',
        ...
        boss: { name: 'Runekeeper Bal', image: 'images/themes/realm/demon-iron.png', threat: 'The Rune Trial', defeatLine: 'Every rune I twisted, you read true. The waystones bow to you now.', reward: 'Sigil of the Rune-Reader' },
      ...
      thorn:  { title: 'The Tangle Cross', subtitle: 'The Sphinx\'s Bargain', icon: '🌹', color: '#e11d48', glow: 'rgba(225,29,72,0.6)',
        ...
        boss: { name: 'The Crossroads Sphinx', image: 'images/themes/realm/demon-thorn.png', threat: 'The Sphinx\'s Trial', defeatLine: 'A thousand years I riddled at this cross. You answered every one.', reward: 'Sigil of First Passage' },
      ...
      bone:   { title: 'The Dragon\'s Ledger', subtitle: 'The Final Curse', icon: '🐉', color: '#fffbeb', glow: 'rgba(255,251,235,0.6)',
        ...
        boss: { name: 'Vermithrax the Ledgerkeeper', image: 'images/themes/realm/demon-bone.png', threat: 'The Ledger Trial', defeatLine: 'Every debt in my hoard, repaid. Rise, Rider. The roads are yours.', reward: 'The Rider\'s Oath' },
  ...
  cozy: {
    ...
    voiceClips: false,
    avatars: [
      { id: 'pip', img: 'images/themes/cozy/avatar-1.png', name: 'Pip Maplewood', body: 'Fox · Zippy', tagline: 'Fast paws, full stops.', lore: 'The grove\'s delivery fox. Knows every lane and every shortcut, and stops at every single stop sign. Every one.' },
      { id: 'willow', img: 'images/themes/cozy/avatar-2.png', name: 'Willow Bramble', body: 'Bunny · Careful', tagline: 'Look twice, hop once.', lore: 'Runs the grove\'s crossing patrol. Has walked every crosswalk in town and will absolutely quiz you about them over tea.' },
      { id: 'chester', img: 'images/themes/cozy/avatar-3.png', name: 'Chester Oakhart', body: 'Bear · Chill', tagline: 'Slow is smooth, smooth is fast.', lore: 'Drives the grove\'s honey truck. Never been honked at, never honked. Believes every rule of the road is really about being kind.' }
    ],
    ...
    houses: {
      blood:  { title: 'Sir Sips-a-Lot', subtitle: 'The Fizzy 0.08', icon: '🦝', color: '#e11d48', glow: 'rgba(225,29,72,0.5)',
        ...
        boss: { name: 'Sir Sips-a-Lot', image: 'images/themes/cozy/demon-blood.png', threat: 'The Fizzy Trial', defeatLine: 'Okay, OKAY. No more cider before driving. You really do know all the numbers.', reward: 'Clear-Head Badge' },
      ...
      ember:  { title: 'Duke Dozy', subtitle: 'The Sleepy Smoke', icon: '🦨', color: '#84cc16', glow: 'rgba(132,204,22,0.5)',
        ...
        boss: { name: 'Duke Dozy', image: 'images/themes/cozy/demon-ember.png', threat: 'The Dozy Trial', defeatLine: 'Allowed doesn\'t mean a good idea before driving. You knew the difference all along.', reward: 'Wide-Awake Badge' },
      ...
      static: { title: 'Pinglet', subtitle: 'The Ping-Ping Parrot', icon: '🦜', color: '#f472b6', glow: 'rgba(244,114,182,0.5)',
        ...
        boss: { name: 'Pinglet', image: 'images/themes/cozy/demon-static.png', threat: 'The Ping-Ping Trial', defeatLine: 'You never looked away once! Not even for a REALLY juicy message. The ducklings thank you.', reward: 'Eyes-Up Badge' },
      ...
      iron:   { title: 'Mixup', subtitle: 'The Sign-Swiping Magpie', icon: '🐦‍⬛', color: '#94a3b8', glow: 'rgba(148,163,184,0.5)',
        ...
        boss: { name: 'Mixup', image: 'images/themes/cozy/demon-iron.png', threat: 'The Mixed-Up Trial', defeatLine: 'Fine, FINE, I\'ll put the signs back. You know every single shape anyway. Show-off.', reward: 'Sign-Reader Badge' },
      ...
      thorn:  { title: 'Honks', subtitle: 'The Never-Yields Goose', icon: '🪿', color: '#2dd4bf', glow: 'rgba(45,212,191,0.5)',
        ...
        boss: { name: 'Honks', image: 'images/themes/cozy/demon-thorn.png', threat: 'The Honking Trial', defeatLine: 'HONK. Fine. You go first. You clearly know exactly who goes first, every time.', reward: 'After-You Badge' },
      ...
      bone:   { title: 'Grandmother Quill', subtitle: 'The Big Quiz', icon: '🦉', color: '#fff7ed', glow: 'rgba(255,247,237,0.5)',
        ...
        boss: { name: 'Grandmother Quill', image: 'images/themes/cozy/demon-bone.png', threat: 'The Big Quiz', defeatLine: 'Every answer, correct. I am so proud of you, dear. The Cruise Badge is yours.', reward: 'The Cruise Badge' },
